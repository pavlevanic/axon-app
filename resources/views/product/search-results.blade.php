...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Rezultati pretrage za: "<span class="text-primary">{{ $query }}</span>"</h2>
                ...
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm rounded-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('product.show', $product->slug) }}" class="btn btn-primary btn-sm rounded-0 w-100">Pogledaj detalje</a>
                        </div>
                    </div>
                </div>
            @endforeach
