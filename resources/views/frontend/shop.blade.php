...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="text-muted mx-auto" style="max-width: 520px;">
            ...
            sve na jednom mestu po najboljim cenama.
        </p>
    </div>
...
<div class="container py-5">
    <div class="d-flex mb-4">
        ...
        <button id="toggleBtn" class="btn btn-primary shadow-sm d-flex align-items-center gap-2"
                            ...
                            <div class="p-3 text-center bg-light position-relative overflow-hidden">
                                <a href="{{ route('product.show', $product->slug) }}" class="d-block">
                                    <img src="{{ asset($product->image) }}"
                                         class="img-fluid {{ $isOutOfStock ? 'opacity-75' : '' }}"
                            ...
                            <div class="card-body d-flex flex-column p-3">
                                ...
                                <div class="mt-auto">
                                    <div class="d-flex flex-column mb-3">
                                        @if($isOutOfStock)
                                            <span class="fs-5 fw-bold ">Trenutno Nedostupno</span>
                                        @elseif($hasDiscount)
